(function(){
  var LPB = window.LPB = window.LPB || {plugins:[],
   genSource:function(){
      ...
      $($temptxt).find(".leipiplugins-orgname").removeClass("leipiplugins-orgname");
      $($temptxt).find(".leipiplugins").removeClass("leipiplugins");
//      $($temptxt).find("input").class();
      $($temptxt).find("span").attr({"leipiplugins":null,"title":null});
