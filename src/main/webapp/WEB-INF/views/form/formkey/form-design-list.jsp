...
<script
	src="${ctx }/js/module/form/formkey/formkey-form-design.js"
	type="text/javascript"></script>
<style type="text/css"]>
th, td {
	text-align: center;
			...
			<tbody>
				<c:forEach items="${page.result }" var="process">
					<tr>
						...
						<td><a class="btn btn-sm btn-success design-forms" target = "_blank" href="${ctx}/form/formkey/form-design?processDefinitionId=${process.id}">表单设计</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
